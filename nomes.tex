...
\newcommand{\murilo}{{Murilo Duarte Gonçalves}}
...
{
	\newcommand{\names}{\rafael ~-~ \erafael ~-~ \rafaelmatricula\\ \victor  ~-~ \evictor ~-~ \victormatricula\\ \vinicius ~-~ \evinivius ~-~ \viniciusmatricula\\  \murilo ~-~ \emurilo ~-~ \murilomatricula\\  }
}
\makeatother
