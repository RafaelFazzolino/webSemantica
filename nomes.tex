...
\newcommand{\hell}{Web Semântica}		%nome do arquivo
% \renewcommand{\autor}{\rafael}							%criador do pdf - só observado nos detalhes do pdf
\newcommand{\assunto}{Ontologia Aplicada à Universidade de Brasília - UnB Gama}			%Nome do experimento
\newcommand{\ver}{\assunto}						%numeração do experimento
\newcommand{\professor}{Edgard Costa}
\newcommand{\curso}{Web Semântica}

%%------------------------------------------------------------------------------
%%------------------------Detalhes para serem revistos--------------------------
\newcommand{\keyw}{Web Semântica, \assunto}	%Keywords
...
\newcommand{\murilo}{{Murilo Duarte}}
\newcommand{\rafaelmatricula}{11/0136942}
\newcommand{\murilomatricula}{12/0130645}
\newcommand{\eduardomatricula}{11/0115104}
\newcommand{\emurilo}{muriloduartegoncalves@hotmail.com}
\newcommand{\erafael}{fazzolino29@gmail.com}
\newcommand{\evinivius}{vinicius@gmail.com}
\newcommand{\eeduardo}{brasil.eduardo1@gmail.com}
\newcommand{\victor}{Victor Hugo Arnaud Deon}
\newcommand{\victormatricula}{13/0136484}
\newcommand{\evictor}{victorhugoad@hotmail.com}
\newcommand{\gabriel}{Gabriel dos Santos Silva}
\newcommand{\gabrielmatricula}{12/0011727}
\newcommand{\egabriel}{gabriel93.silva@gmail.com}
\newcommand{\antonio}{Antônio Carvalho de Oliveira}
\newcommand{\antoniomatricula}{11/0058496}
\newcommand{\eantonio}{antoniojk7@gmail.com}
...
{
	\newcommand{\names}{\rafael ~-~ \erafael ~-~ \rafaelmatricula\\ \victor  ~-~ \evictor ~-~ \victormatricula\\  \murilo ~-~ \emurilo ~-~ \murilomatricula\\  \antonio ~-~ \eantonio ~-~ \antoniomatricula\\ \gabriel ~-~ \egabriel ~-~ \gabrielmatricula}
}
\makeatother
